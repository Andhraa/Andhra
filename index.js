...
const instagram = 'https://instagram.com/andhraa.s'; 
const telegram = 'https://t.me/Andhra 14'; 
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@andhraa.s')
